  ...
  <FooterBar>
    <FooterContentWrapper> {/* Wrap content for max-width and padding */}
      <ActionRow>
        ...
        <Actions>
          <ActionBtn href="#">VISIT</ActionBtn>
          <ActionBtn href="#">APPLY</ActionBtn>
          <ActionBtn href="#">GIVE</ActionBtn>
        </Actions>
      </ActionRow>
      <Divider />
      <MainFooterGrid>
        ...
        <div> {/* Container for Quick Links and Socials in the right column */}
          <QuickLinks> {/* Quick Links */}
            <QuickLink href="#">Employment</QuickLink>
            <QuickLink href="#">Tang Institute</QuickLink>
            <QuickLink href="#">Addison Gallery</QuickLink>
            <QuickLink href="#">Contact Us</QuickLink>
            <QuickLink href="#">Privacy Policy</QuickLink>
            <QuickLink href="#">Terms of Use</QuickLink>
          </QuickLinks>
